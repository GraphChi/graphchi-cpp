...
void output_knn_result(std::string filename, vid_t numvertices, vid_t max_left_vertex) {
  MMOutputter_ratings mmoutput_ratings(filename + ".ratings", 0, max_left_vertex + 1, "This file contains user scalar rating output matrix U. In each row K top scalar ratings of different items.");
  MMOutputter_ids mmoutput_ids(filename + ".ids", 0, max_left_vertex +1 ,"This file contains item ids matching the ratings. In each row the top K item ids for this user.");
