...
rm -fR smallnetflix_mm.*
 ./toolkits/collaborative_filtering/pmf --training=smallnetflix_mm --validation=smallnetflix_mme --quiet=1 --minval=1 --maxval=5 --max_iter=10 --pmf_burn_in=5 --test=smallnetflix_mme --regnormal=0
...
rm -fR smallnetflix_mm.* smallnetflix_mme.*
